...
<head>
<meta charset="UTF-8">
	<title>Erro 404 - SysAcadêmico</title>
    <link type="text/css" rel="stylesheet" href="http://netdna.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css"> <!--css file link in bootstrap folder-->
</head>
<body>
<div class="container">
  <br>
          ...
          <p>A página que você está procurando pode ter sido removida, mudado de nome, ou está temporariamente indisponível. Tente o seguinte:</p>
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item">Se você chegou a esta página clicando em um link,
                <a href="http://fb.me/msg/SysSolut"><b>contate-nos</b></a> para nos alertar que o link está formatado incorretamente.</li>
