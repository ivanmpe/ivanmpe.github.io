...
?>
	...
	<form class="col-md-12 form-horizontal" method="post" action="update.php" >
		<fieldset>
			<!-- Nome do Form -->
			<legend>Editar</legend>

			<input type="hidden" name="id" value="<?php echo $linha[0]; ?>" /> <!-- passando o valor da id em um campo oculto -->
			<p>Nome: <input type="text" name="nome" value="<?php echo $linha[1]; ?>" /><!-- mostrando dentro do form o valor do campo nome -->
			<p>Senha: <input type="password" name="senha" value="<?php echo $linha[2]; ?>" /><!-- mostrando dentro do form o valor do campo email -->
			<p>Email: <input type="text" name="email" value="<?php echo $linha[3]; ?>" />
			<p>Frase: <textarea type="text" name="frase"><?php echo $linha[4]; ?></textarea>
			<div class="form-group">
				<div class="col-md-4">
				<br><input type="button" value="Voltar" class="btn btn-primary" onClick="JavaScript: window.history.back();">
